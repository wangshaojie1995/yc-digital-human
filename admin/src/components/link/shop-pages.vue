...
const linkList = ref([
    ...
    {
        path: '/digitalhuman/replicon/index',
        name: '形象克隆',
        type: LinkTypeEnum.SHOP_PAGES,
        canTab: false
    },
    ...
    {
        path: '/digitalhuman/works/create',
        name: '创作视频',
        type: LinkTypeEnum.SHOP_PAGES,
    },
    {
        path: '/digitalhuman/works/index',
        name: '我的作品',
        type: LinkTypeEnum.SHOP_PAGES,
    },
    {
        path: '/digitalhuman/cdkey/index',
        name: '卡密兑换',
        type: LinkTypeEnum.SHOP_PAGES
    },
    {
        path: '/digitalhuman/package/index',
        name: '套餐充值',
        type: LinkTypeEnum.SHOP_PAGES
    },
])
