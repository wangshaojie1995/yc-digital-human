<template>
    <popup ref="popupRef" title="点数调整" width="500px" @confirm="handleConfirm" :async="true" @close="popupClose">
        <div class="pr-8">
            <el-form ref="formRef" :model="formData" label-width="120px" :rules="formRules">
                <el-form-item label="当前点数"> {{ value }} </el-form-item>
                <el-form-item label="点数增减" required prop="action">
                    <el-radio-group v-model="formData.action">
                        <el-radio :value="1">增加点数</el-radio>
                        <el-radio :value="2">扣减点数</el-radio>
                    </el-radio-group>
                </el-form-item>
                <el-form-item label="调整点数" prop="num">
                    <el-input :model-value="formData.num" placeholder="请输入调整的金额" type="number" @input="numberValidate" />
                </el-form-item>
                <el-form-item label="调整后点数"> {{ adjustmentMoney }} </el-form-item>
